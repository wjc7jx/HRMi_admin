        ...
        <div class="panel">
          ...
          <div class="todo-list">
            <div class="todo-item">
              <span>组织总人数</span>
              <!-- 起始值 终点值  滚动时间 -->
              <count-to :start-val="0" :end-val="228" :duration="3000" />
            </div>
            <div class="todo-item">
              <span>正式员工</span>
              <count-to :start-val="0" :end-val="334" :duration="3000" />
            </div>
            <div class="todo-item">
              <span>合同待签署</span>
              <count-to :start-val="0" :end-val="345" :duration="3000" />

            </div>
            <div class="todo-item">
              <span>待入职</span>
              <count-to :start-val="0" :end-val="890" :duration="3000" />
